...
SQLALCHEMY_DATABASE_URI = "mysql+pymysql://root:Password123@@localhost/bookstoredb"
##dialect+driver://username:password@host:port/database
SQLALCHEMY_TRACK_MODIFICATIONS = True
MAIL_SERVER = 'smp.googlemail.com'
MAIL_USERNAME = "shinichi24567@gmail.com"
MAIL_PASSWORD = "shinichi24567123"  # đặt lại password cho hợp lý
UPLOAD_FOLDER = 'D:\WORKSPACE\DoAnQLTV_Python_Angular2+\python-flask'
MAX_CONTENT_LENGTH = 16 * 1024 * 1024
ALLOWED_EXTENSIONS = ["png", "jpg", "jpeg", "gif"]

CLOUD_NAME = 'dra7ojfcd'  # Account name: shinichi24567@gmail.com
